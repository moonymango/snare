...
import stachelsau.snare.physics.IBoundingVolumeProvider;
import stachelsau.snare.res.BaseResHandle;
import stachelsau.snare.res.data.MeshResource.BaseImportTransform;
import stachelsau.snare.ui.scene3D.mesh.Mesh.IMeshDataProvider;
...
public class MeshResHandle extends BaseResHandle implements IBoundingVolumeProvider,
    ...
    /* (non-Javadoc)
     * @see stachelsau.snare.res.loader3d.IBufferProvider#getVertexAttribs()
     */
    ...
    /* (non-Javadoc)
     * @see stachelsau.snare.res.loader3d.IBufferProvider#getIndices()
     */
    ...
    /* (non-Javadoc)
     * @see stachelsau.snare.res.loader3d.IBufferProvider#getStride()
     */
    ...
    /* (non-Javadoc)
     * @see stachelsau.snare.res.loader3d.IBufferProvider#getNormalOffset()
     */
    ...
    /* (non-Javadoc)
     * @see stachelsau.snare.res.loader3d.IBufferProvider#getVertexOffset()
     */
    ...
    /* (non-Javadoc)
     * @see stachelsau.snare.res.loader3d.IBufferProvider#getIndicesCnt()
     */
