...
import stachelsau.snare.events.IGameObjRotateEvent;
import stachelsau.snare.events.IGameObjScaleEvent;
import stachelsau.snare.game.logic.IPositionable3D;
import stachelsau.snare.game.logic.IRotatable3D;
import stachelsau.snare.game.logic.IScalable3D;
import stachelsau.snare.util.IMimic;
import stachelsau.snare.util.MatrixAF;
import stachelsau.snare.util.PoolItem;
import stachelsau.snare.util.QuaternionAF;
