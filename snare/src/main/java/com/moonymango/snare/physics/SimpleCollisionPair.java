...
public class SimpleCollisionPair extends PoolItem implements ICollisionPair
{
    ...
    /* (non-Javadoc)
     * @see com.moonymango.snare.physics.ICollisionPair#getObjIdA()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.moonymango.snare.physics.ICollisionPair#getObjIdB()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.moonymango.snare.physics.ICollisionPair#getCollisionPoint()
     */
    @Override
